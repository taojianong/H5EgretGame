...
(function (fairui) {
    ...
    var Alert = (function (_super) {
        ...
        Alert.show = function (content, title, flag, data) {
            ...
            data = data || {};
            data["content"] = Global.lang.getLang(content);
            data["title"] = title;
            data["flag"] = flag;
        ...
        Alert.prototype.initUI = function () {
            _super.prototype.initUI.call(this);
        };
        Alert.prototype.addAllListener = function () {
            _super.prototype.addAllListener.call(this);
            this.addGameListener(egret.TouchEvent.TOUCH_TAP, this.touchOkHandler, this.btn_ok);
            this.addGameListener(egret.TouchEvent.TOUCH_TAP, this.touchCancelHandler, this.btn_cancel);
            this.addGameListener(egret.TouchEvent.TOUCH_TAP, this.close, this.btn_close);
        };
        /**点击确定*/
        ...
        Alert.prototype.show = function (data) {
            ...
            if (data != null) {
                ...
                if (data["okTitle"]) {
                    ...
                    this.btn_ok.text = Global.lang.getLang("login_ui_txt1");
                }
                ...
                if (data.hasOwnProperty("showText")) {
                    ...
                    this.btn_ok.text = "确定";
                    Global.lang.getLang("login_ui_txt1");
                    this.btn_cancel.text = "取消"; // Global.lang.getLang("cancel");
                }
            }
        };
